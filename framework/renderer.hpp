...
public:
  ...
  Color getDiffuseIllumination(Hit const& hit, vec3 const& normVecToLight, Scene const& scene, shared_ptr<Shape> const& nearestObject, shared_ptr<Light> const& light);
